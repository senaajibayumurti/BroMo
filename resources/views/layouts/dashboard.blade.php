<x-app-layout>
    ...
    <div class="bm-font-clr1 bm-font-bold3 bm-font-32">Halo,  
        <span class="bm-font-clr1 bm-font-bold3 bm-font-32">Dono</span>
    </div>
        <div class="bm-font-clr1 bm-font-bold1 bm-font-24">Selamat Datang di 
            <span class="bm-font-clr1 bm-font-bold1 bm-font-24">Kandang 1</span>
        </div>
    @endpush
    <div class="bm-font-clr3 bm-font-bold3 bm-font-36">BAHAYA</div>
